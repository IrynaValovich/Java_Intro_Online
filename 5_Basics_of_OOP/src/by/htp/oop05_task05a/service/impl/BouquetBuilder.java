...
public class BouquetBuilder extends FlowerCompositionBuilder {
	...
	public FlowerCompositionBuilder appendCompositionType() {
		this.compositionType = CompositionType.BOUQUET;		
		return this;
	}
	...
	public FlowerCompositionBuilder appendWrapp() throws ServiceException {
		Wrapp newWrapp;
		try {
			newWrapp = wrappResource.readFile().get(1);
	...
	public FlowerComposition buildFlowerComposition() {		
		FlowerComposition fc = new FlowerComposition(compositionType, flowers, wrapp, price);
		return fc;
