...
public class FlowerBoxBuilder extends FlowerCompositionBuilder {
	...
	public FlowerCompositionBuilder appendCompositionType() {
		this.compositionType = CompositionType.FLOWERS_IN_BOX;
		return this;
	}
	...
	public FlowerCompositionBuilder appendWrapp() throws ServiceException {
		Wrapp newWrapp;
		try {
			newWrapp = wrappResource.readFile().get(0);
